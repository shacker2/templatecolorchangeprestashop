...
<div class="bootstrap panel">
	<div class="panel-heading">
		<i class="icon-picture-o"></i> {l s="Video / help"}
	</div>
<iframe width="560" height="315" src="https://www.youtube.com/embed/WD6Gkn2E8iM?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
</div>
